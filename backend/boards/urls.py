...
from .views import BoardDetail, BoardList, BoardStar, ItemList, ItemDetail, DueItemList, ListShow, ListDetail, LabelList, LabelDetail, CommentList, CommentDetail, AttachmentDetail, AttachmentList
...
urlpatterns = [
    ...
    path('items/due/', DueItemList.as_view()),
